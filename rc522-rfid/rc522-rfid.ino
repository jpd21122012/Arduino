...
// Change as required 
#define SS_PIN      D10      // Same pin used as hardware SPI (SS)
#define RST_PIN     D5
#define MOSI_PIN    D11      // hardware SPI: A5
#define MISO_PIN    D12      //     "     " : A4
#define SCK_PIN     D13      //     "     " : A3

/* Create an instance of the RFID library */

#if defined(_USE_SOFT_SPI_)
    RFID RC522(10, 5, 11, 12, 13);    // Software SPI
#else
    RFID RC522(10, 5);                                 // Hardware SPI
#endif
